...
function Navbar({ isLoggedIn, setIsLoggedIn }) {
  ...
  return (
    <div className={`floating-navbar ${menuOpen ? "active" : ""}`}>
      <span className="nav-logo" onClick={() => navigate("/")}>
        Genescope
      </span>
      <div
...
{/* 
      ...
      <div className={`nav-links ${menuOpen ? "active" : ""}`}>
        <button
          className={`nav-button ${location.pathname === "/" ? "active-tab" : ""}`}
          onClick={() => navigate("/")}
        >
          Home
        </button>
        ...
        {isLoggedIn && (
          <>
            <button
              className={`nav-button ${location.pathname === "/fileupload" ? "active-tab" : ""}`}
              onClick={() => navigate("/fileupload")}
            >
              File Upload
            </button>
            ...
            <button
              className={`nav-button ${location.pathname === "/myfiles" ? "active-tab" : ""}`}
              onClick={() => navigate("/myfiles")}
            >
              My Files
            </button>
